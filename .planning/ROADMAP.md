...
Plans:
- [ ] 01-01-PLAN.md — Project scaffold: venv (python3.11), pip install, requirements.txt, config.py, directory structure, pytest.ini, test stubs
...
|-------|----------------|--------|-----------|
| 1. RPC Infrastructure + Callback Pipeline | 0/4 | Not started | - |
